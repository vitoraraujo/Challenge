...
class ChallengesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create challenge" do
    assert_difference('Challenge.count') do
      post challenges_url, params: { challenge: { context: @challenge.context, user_id: @challenge.user_id } }
    end
  ...
  test "should update challenge" do
    patch challenge_url(@challenge), params: { challenge: { context: @challenge.context, user_id: @challenge.user_id } }
